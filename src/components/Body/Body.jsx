...
const Body = () => {
  ...
  return (
    <div className='text-white text-center flex flex-col items-center justify-end bg-[center_center] bg-no-repeat bg-[initial] bg-cover h-[100vh]' style={{backgroundImage: `url(${Marriage_Banner})`, textShadow: '1px 1px 3px #0e0e0e'}}>
      ...
      <p className='font-medium text-xl mb-24' style={{ fontFamily: "'Signika Negative', sans-serif" }}>12 - 04 - 2026</p>
    </div>
  )
}
